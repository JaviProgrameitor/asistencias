...
function FilasJustificantes(props) {
  ...
  const { nombreJustificante, apellidoJustificante, claveEstudianteJustificante, numeroTelefonoJustificante, fechaEmisionJustificante,
    horaEmisionJustificante, fechaJustificante, motivoJustificante, explicacionJustificante, fotoJustificante, id} = props.datos
  ...
  return (
    <tr className={`fila fila-administrador ${tipo} ${activo}`} onClick={() => cambiarValor(fotoJustificante)}>
      ...
      {
        ultimaFila ? <td className='td-admin ultima-td-admin'><AiFillCheckCircle className="icon-justificante icon-aceptar" onClick={aceptarJustificacion} /> <TiDelete className="icon-justificante icon-rechazar" onClick={rechazarJustificacion} /></td>
        : <></>
      }
    </tr>
  )
